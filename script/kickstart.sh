...
# External files
PACKAGES_SCRIPT="https://cdn.jsdelivr.net/gh/nekomiya-hinata/netdata_files@v1.0/script/install-required-packages.sh"
...
set_tarball_urls() {
  ...
  if [ "$1" = "stable" ]; then
    ...
    # Simple version
    latest="v1.31.0"
    export NETDATA_TARBALL_URL="https://cdn.jsdelivr.net/gh/nekomiya-hinata/netdata_files@v1.3.4/archive/netdata-v1.31.0.tar.gz"
    export NETDATA_TARBALL_CHECKSUM_URL="https://cdn.jsdelivr.net/gh/nekomiya-hinata/netdata_files@v1.3.4/sha256sums.txt"
  else

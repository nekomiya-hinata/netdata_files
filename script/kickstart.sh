...
set_tarball_urls() {
  ...
  if [ "$1" = "stable" ]; then
    ...
    # Simple version
    latest="v1.31.0"
    export NETDATA_TARBALL_URL="https://cdn.jsdelivr.net/gh/nekomiya-hinata/netdata_files@v1.3.3/archive/netdata-v1.31.0.tar.gz"
    export NETDATA_TARBALL_CHECKSUM_URL="https://cdn.jsdelivr.net/gh/nekomiya-hinata/netdata_files@v1.3.3/sha256sums.txt"
  else
